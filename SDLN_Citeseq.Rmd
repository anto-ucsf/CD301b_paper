...
##Accession number : 
##SDLN.Citeseq.rds is the end product, SDLN.Citesq.data.rds is the raw seurat object

## raw files matrices: "AW75_LN_barcodes.tsv.gz" "AW75_LN_features.tsv.gz" "AW75_LN_matrix.mtx.gz"
...
SDLN_Citeseq.data<- CreateSeuratObject(counts = SDLN_Citeseq.data$`Gene Expression`, project = "LN",assay="RNA", min.cells = 3, min.features = 200)
